...
generateHTML =(data) => {
    ...
    for(let i=0; i< data.length; i++) {
        ...
        if(role ==='Intern') {
            ...
            pageArray.push(internSection);
        }
    }

    const employeeSection = pageArray.join('');
...
const generateTeamPage = function (employeeSection) {
    return `
        <!DOCTYPE html>
        <html lang ="en">
        <head>
